...
(defun collect-documentation (package &key no-package flatten)
...
(defun generate-includes (directory packages &key base-package flatten)
  ...
  (handler-bind ((warning #'muffle-warning))
    (let ((directory (merge-pathnames (pathname directory)))
      ...
      (dolist (package packages)
        (dolist (doc (collect-documentation (find-package package) :flatten flatten))
